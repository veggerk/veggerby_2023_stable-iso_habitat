---
title: "stickleback mixing models with MixSIAR"
...
#load_mix_data
mix <- load_mix_data(filename=here("data", "04_clean data", "stickleback.csv"),
...
jags.1 <- run_model(run="very long",mix,source,discr,model_filename,
 ...
 # save model fit so that it can be called up again without having to be run again
  saveRDS(jags.1, here("model_output","stickleback", "no effect", "stickleback.model.no.effect.rds"))
...
jags.1<-readRDS(here("model_output", "stickleback", "no effect", "stickleback.model.no.effect.rds"))
