...
#load_mix_data
mix <- load_mix_data(filename=here("data", "04_clean data", "staghorn_sculpin.csv"),
iso_names=c("d15N","d13C"), factors=NULL,fac_random=NULL,
fac_nested=NULL, cont_effects=NULL)

#load_source_data
source <- load_source_data(filename=here("data", "04_clean data", "sources.csv"),
source_factors=NULL, conc_dep=FALSE, data_type = "raw", mix)

#Load discrimination data
discr <- load_discr_data(filename=here("data", "04_clean data", "TEF.csv"), mix)
