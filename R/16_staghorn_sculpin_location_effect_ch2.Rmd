...
iso_names=c("d15N","d13C"), factors="location",fac_random=FALSE,
...
jags.1 <- run_model(run="very long",mix,source,discr,model_filename,
 ...
 # save model fit so that it can be called up again without having to be run again
  saveRDS(jags.1, here("model_output","staghorn_sculpin", "location effect", "staghorn_sculpin.model.location.effect.rds"))
...
jags.1<-readRDS(here("model_output", "staghorn_sculpin", "location effect", "staghorn_sculpin.model.location.effect.rds"))
