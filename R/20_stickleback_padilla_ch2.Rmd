---
title: "stickleback from Padilla mixing models with MixSIAR"
...
#load_mix_data
mix <- load_mix_data(filename=here("data", "04_clean data", "stickleback_padilla.csv"),
...
jags.1 <- run_model(run="very long",mix,source,discr,model_filename,
 ...
 # save model fit so that it can be called up again without having to be run again
  saveRDS(jags.1, here("model_output","stickleback", "padilla", "stickleback.model.padilla.rds"))
...
#jags.1<-readRDS(here("model_output", "stickleback", "padilla", "stickleback.model.no.effect.rds"))
